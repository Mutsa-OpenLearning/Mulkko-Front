      ...
      <div className="mx-auto flex h-full w-[244px] flex-col py-6">
        ...
        <div className="mt-10 flex items-center justify-between">
          <div className="flex min-w-0 items-center gap-3">
            <div className="flex h-8 w-8 shrink-0 items-center justify-center overflow-hidden rounded-full bg-[#F2F4F7]">
              <img
                src={profileIcon}
                alt=""
            ...
            <span className="max-w-[140px] truncate text-body-5 font-medium text-text-primary">
              {nickname}
            </span>
          </div>
